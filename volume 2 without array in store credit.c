...
int main()
{
    ...
    /*
    //10 student 10 coarse credit with array
    int course_credit[10];
    */

    //10 student 10 credit without array
    int course_1_credit;
    int course_2_credit;
    int course_3_credit;
    int course_4_credit;
    ...
    //without array in credit storage
    printf("student course 1 credit:");
    scanf("%d",&course_1_credit);

    printf("student course 2 credit:");
    scanf("%d",&course_2_credit);

    printf("student course 3 credit:");
    scanf("%d",&course_3_credit);

    printf("student course 4 credit:");
    scanf("%d",&course_4_credit);

    printf("student course 5 credit:");
    scanf("%d",&course_5_credit);

    printf("student course 6 credit:");
    scanf("%d",&course_6_credit);

    printf("student course 7 credit:");
    scanf("%d",&course_7_credit);

    printf("student course 8 credit:");
    scanf("%d",&course_8_credit);

    printf("student course 9 credit:");
    scanf("%d",&course_9_credit);
    ...
    student_cgpa[3]=student_cgpa[3]+student_gradepoint[3][9]*3;
    ...
    for(counter=0;counter<10;counter++)
        {
            for(course=0;course<10;course++)
            {
                ...
                student_cgpa[counter]=student_cgpa[counter]+student_cgpa[counter][course]*3;
            }
        }
